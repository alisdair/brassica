...
![ARM instruction encoding for data processing instruction](assets/arm.svg)
...
![MIPS instruction encoding for ADDI instruction](assets/mips.svg)

Or the similar PowerPC, also called `addi`:

![PowerPC instruction encoding for ADDI instruction](assets/powerpc.svg)
...
![ARM immediate value encoding](assets/arm-immediate-value-encoding.svg)
...
![ARM immediate value rotations](assets/rotations.svg)
